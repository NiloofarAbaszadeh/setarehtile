            ...
            <LazyMotion strict features={domMax}>
                <Swiper
                    ...
                    {props.data.filter(item => item.state).map((item, i) => {
                        return (
                            <LazyLoad>
                                <SwiperSlide key={i} className="overflow-hidden" onMouseEnter={() => setHovered(i)} onMouseLeave={() => setHovered(null)}>
                                    <a href={`${item.link}`} >
