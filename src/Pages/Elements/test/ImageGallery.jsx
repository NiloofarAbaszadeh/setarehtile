...
const ImageGalleryPage = () => {
  ...
  useEffect(() => {
    const GetData = async () => {
      await axios.get(`${host}/api/gwahy-dakhlies?populate[reward][populate]=*`, {
  ...
  return (
    <>
    {loading && <section className="py-[130px] cover-background lg:py-[90px] md:py-[75px] sm:py-[50px]" style={{ backgroundImage: `url(${host}${data[0].attributes.boardImage.data.attributes.formats.medium.url})` }}>
