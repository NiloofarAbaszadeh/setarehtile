...
const ContactUsClassicPage = (props) => {  
  ...
  useEffect(() => {
    const GetData = async () => {
      await axios.get(`${host}/api/call-us?populate=deep`, {
  ...
  return ( <>
    <Helmet>
        <title> تماس با ما | کاشی و سرامیک ستاره  </title>
    </Helmet>
        ...
        <Container className="h-full relative z-[2]">
          <Row className="justify-center h-full">
            <Col xl={6} lg={7} md={8} className="relative font-serif text-center flex justify-center flex-col">
              ...
              <h2 className="text-white font-medium -tracking-[1px] mb-0 text-[50px]">برقراری ارتباط و تماس با ما</h2>
            </Col>
          </Row>
        </Container>
      </div>
        ...
        <Container>
          <Row className="justify-center">
            <Col xl={6} lg={7} className="text-center mb-[4.5rem] md:mb-12">
              <h4 className="font-medium text-fastblue text-xxlg mb-3">منتظر نظرات شما هستیم</h4>
              <span className="mb-0 -tracking-[.5px] text-basecolor text-xlg block">درخواست ها، پیشنهادات , انتقادات.</span>
            </Col>
            <Col className="col-xl-10 col-sm-12 col-xs-12">
                  ...
                  <div className='w-[700px] mx-3'>
                    <div className='form-grid'>
                        ...
                        <input
                          ...
                          className="py-[12px] px-[20px] w-full text-xxmd border-[1px] border-solid border-[#dfdfdf] mb-[26px] rounded-[5px] ml-4"
                        />
                        <input
                          type="text"
                          name="phone"
                        ...
                        <input value={formData.comment} onChange={handelChange} className="border-[1px] rounded-[5px] border-solid border-[#dfdfdf] w-full py-[14px] px-[20px] text-xxmd h-[210px]"  name="comment" placeholder="متن پیغام شما"></input>
                    </div>    
                    <div className='flex-fix'>
                      <button className={`button-custom w-auto mt-[35px] ${isSubmitting ? " loading" : ""}`} title="فرستادن پیام" onClick={handelSubmmit}> فرستادن پیام </button>
                    </div>
                    </div>
                    <AnimatePresence>
              ...
              {commentSend !== null ?
                ...
                <div className='flex items-center justify-center mt-5'>
                  <p>مشکلی در هنگام ارسال پیش آمد، لطفا بعدا دوباره تلاش کنید</p>
                </div>   
              : <></>}
        ...
        <Container>
          <Row className="justify-center">
            <Col lg={7} md={9} className="col-12 text-center mb-[108px] lg:mb-[90px] sm:mb-14">
              <span className="text-white text-xxlg opacity-100 block mb-[10px]">در سراسر دنیا با شما هستیم</span>
              <h4 className="text-xlg text-white opacity-80 mb-0">اطلاعات شعبه ها</h4>
            </Col>
          </Row>
          <Row className="justify-center">
                ...
                <Col key={i} lg={4} md={6} sm={8} className="col-12 fancy-box-item md:mb-[30px] xs:mb-[15px]">
                  ...
                  <div className="relative feature-box-main px-16 py-12 rounded-[5px] overflow-hidden lg:px-12 xs:mx-8 xs:mb-4">
                    <div className="flex items-center">
                      <img width="16" height="16" loading="lazy" src="/assets/img/webp/contact-ir-img-flag-01.png" className="w-[35px] block feature-box-icon " alt='UK' />
                    ...
                    {item.phone && <span className="block font-medium mt-[10px] transition-default text-darkgray leading-[20px] w-full">تلفن: {item.phone}</span>}
      ...
      <section className="py-[80px] md:py-[45px] sm:py-[20px]">
        <Container>
          <Row className="justify-center items-center">
            <Col xs={12} xl={3} lg={4} md={5} sm={6} className="lg:flex lg:justify-end xs:mb-[5px] xs:justify-center">
              <span className="font-medium text-xlg text-darkgray inline-block -tracking-[.5px] lg:text-lg">در فضای مجازی با ما در ارتباط باشید</span>
            </Col>
