...
const LeftSideBarTilse = (props) => {
    ...
    useEffect(() => {
        const GetData = () => {
        axios.get(`${host}/api/products?populate[baseInfo][populate][0]=size,shape,type,stamp,design,brandName,bodyColor,glazeType,galeb,special_types,bakeType,color_themes,use_places&populate[image][populate][1]=formats&sort[0]=id:desc`, {
