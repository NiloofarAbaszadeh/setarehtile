...
const LoginRegister = () => {
      ...
      await axios.get(`${host}/api/karbrans?filters\[username]=${formData.user}`, {
        ...
        .then((res) => {
          res.data.data.length !== 0
            ? DirectToDashboard(res.data.data[0].attributes)
            : setErr(true);
        });
    } catch (e) {
      console.log(e);
  ...
  return (
    <div>
      ...
      {!loadingScreen && (
        <div className="flex justify-center items-center bg-white w-full h-[100vh] fixed top-0 fix z-50 top-[-25px]">
          <ScaleLoader
            color={"#db1010"}
      ...
      {loadingScreen && loading && (
        <m.section
          className="fix bg-cover top-0 bg-darkslateblue h-[100vh] flex items-center justify-center"
          {...fadeIn}
                        ...
                        <div>
                          <Form>
                            ...
                            <Checkbox
                              ...
                              className="inline-block mr-[5px] mt-[15px]"
                              labelClass="flex items-center mb-[25px]"
                            >
                              <span className="mr-[5px] text-base mt-[15px]">
                                {" "}
                                مرا به خاطر بسپار{" "}
                              </span>
                            </Checkbox>
                            ...
                            />
                            {err && (
                              <div className="text-center c-c-red mt-[20px]">
                            ...
                            <div className="text-right mt-[20px]">
                              <p className="text-[11px] text-gray px-2">
                                در صورت فراموشی اطلاعات خود، با بخش اطلاعاتی
                                مربوطه تماس بگیرید
                              </p>
                            </div>
                          </Form>
