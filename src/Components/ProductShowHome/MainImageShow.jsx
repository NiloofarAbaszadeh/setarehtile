...
const MainImageShow = (props) => {
  ...
  return <div className="w-full h-full my-12">
    <div className="relative">
      ...
      {props.data.ShowPins.map(pin => {
        return <PopupShow position={[pin.left / props.data.MainImage.data.attributes.width * 100 , pin.top / props.data.MainImage.data.attributes.height * 100]} tile={pin} />
      })}
    </div>
  </div>
}
