  ...
  return (
    <Container>
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        ...
        <Button  variant="contained" color="inherit" startIcon={<Iconify className="ml-4" icon="eva:plus-fill" />}>
          <span className='pl-4 py-1'>کاربر جدید</span>
        </Button>
      </Stack>
            ...
            <Table sx={{ minWidth: 800 }}>
              <UserTableHead
                ...
                headLabel={[
                  ...
                  { id: 'role', label: 'نقش' },
                  { id: 'isVerified', label: 'بررسی شده', align: 'center' },
